(function () {
	...
	angular.module("ariaNg").run([
		...
		function (
			...
			$rootScope.loadPromise = aria2.init();
			aria2.addInitCallBack(function () {
				console.log("Aria2 initialized successfully.");
				aria2TaskService.reconnect();
				console.log("Aria2 reconnect successfully.");
			});
